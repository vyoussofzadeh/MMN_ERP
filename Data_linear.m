...
for i = 4:N
   ...
   X(3,i) = -0.4*X(1,i-3)                                     + W(3,i) + a(3)*W(6,i) + b(3)*W(7,i-1) + c(3)*W(7,i-2);
   X(4,i) = -0.5*X(1,i-2) + 0.25*r*X(4,i-1) + 0.25*r*X(5,i-1) + W(4,i) + a(4)*W(6,i) + b(4)*W(7,i-1) + c(4)*W(7,i-2);
   X(5,i) = -0.25*r*X(4,i-1) + 0.25*r*X(5,i-1)                + W(5,i) + a(5)*W(6,i) + b(5)*W(7,i-1) + c(5)*W(7,i-2);
